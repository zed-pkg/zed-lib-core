...
export const zed_projects = pgTable("zed_projects", {
	...
	index("zed_projects_org_idx").using("btree", table.org_id.asc().nullsLast().op("uuid_ops"), table.updated_at.desc().nullsFirst().op("timestamptz_ops")),
	uniqueIndex("zed_projects_org_slug_active_uq").using("btree", table.org_id.asc().nullsLast().op("text_ops"), table.slug.asc().nullsLast().op("uuid_ops")).where(sql`(is_soft_deleted = false)`),
...
export const zed_users = pgTable("zed_users", {
	...
	uniqueIndex("zed_users_subject_realm_uq").using("btree", table.auth_realm.asc().nullsLast().op("text_ops"), table.shared_auth_subject.asc().nullsLast().op("text_ops")),
]);
...
export const zed_orgs = pgTable("zed_orgs", {
	...
	index("zed_orgs_created_by_idx").using("btree", table.created_by_user_id.asc().nullsLast().op("uuid_ops")).where(sql`(created_by_user_id IS NOT NULL)`),
	...
	uniqueIndex("zed_orgs_slug_active_uq").using("btree", table.slug.asc().nullsLast().op("text_ops")).where(sql`(is_soft_deleted = false)`),
...
export const zed_project_invitations = pgTable("zed_project_invitations", {
	...
	index("zed_project_invitations_project_idx").using("btree", table.project_id.asc().nullsLast().op("timestamptz_ops"), table.created_at.desc().nullsFirst().op("timestamptz_ops")),
	...
	uniqueIndex("zed_project_invitations_token_hash_uq").using("btree", table.token_hash.asc().nullsLast().op("text_ops")),
]);
...
export const zed_org_invitations = pgTable("zed_org_invitations", {
	...
	index("zed_org_invitations_org_idx").using("btree", table.org_id.asc().nullsLast().op("timestamptz_ops"), table.created_at.desc().nullsFirst().op("timestamptz_ops")),
	...
	uniqueIndex("zed_org_invitations_token_hash_uq").using("btree", table.token_hash.asc().nullsLast().op("text_ops")),
]);
...
export const zed_packages = pgTable("zed_packages", {
	...
	index("zed_packages_download_count_idx").using("btree", table.download_count.desc().nullsFirst().op("int8_ops")).where(sql`(is_soft_deleted = false)`),
	...
	uniqueIndex("zed_packages_org_name_active_uq").using("btree", table.org_id.asc().nullsLast().op("uuid_ops"), table.name.asc().nullsLast().op("uuid_ops")).where(sql`(is_soft_deleted = false)`),
	foreignKey({
			columns: [table.project_id],
			foreignColumns: [zed_projects.id],
			name: "zed_packages_project_fk"
		}).onDelete("set null"),
	index("zed_packages_project_idx").using("btree", table.project_id.asc().nullsLast().op("uuid_ops")).where(sql`(project_id IS NOT NULL)`),
	index("zed_packages_public_recent_idx").using("btree", table.created_at.desc().nullsFirst().op("timestamptz_ops")).where(sql`(((visibility)::text = 'public'::text) AND (is_soft_deleted = false))`),
...
export const zed_dependency_graph_artifacts = pgTable("zed_dependency_graph_artifacts", {
	...
	uniqueIndex("zed_dependency_graph_artifacts_declared_root_uq").using("btree", table.root_package_version_id.asc().nullsLast().op("uuid_ops")).where(sql`((graph_kind)::text = 'declared'::text)`),
	...
	uniqueIndex("zed_dependency_graph_artifacts_digest_uq").using("btree", table.graph_digest.asc().nullsLast().op("text_ops")),
	...
	index("zed_dependency_graph_artifacts_resolved_input_idx").using("btree", table.resolution_input_digest.asc().nullsLast().op("text_ops")).where(sql`((graph_kind)::text = 'resolved'::text)`),
	...
	index("zed_dependency_graph_artifacts_root_created_idx").using("btree", table.root_package_version_id.asc().nullsLast().op("timestamptz_ops"), table.created_at.desc().nullsFirst().op("timestamptz_ops")),
	foreignKey({
	...
	index("zed_dependency_graph_artifacts_unsealed_idx").using("btree", table.created_at.asc().nullsLast().op("timestamptz_ops")).where(sql`(sealed_at IS NULL)`),
]);
...
export const zed_package_versions = pgTable("zed_package_versions", {
	...
	index("zed_package_versions_package_published_idx").using("btree", table.package_id.asc().nullsLast().op("timestamptz_ops"), table.published_at.desc().nullsFirst().op("uuid_ops")),
	uniqueIndex("zed_package_versions_package_version_uq").using("btree", table.package_id.asc().nullsLast().op("text_ops"), table.version.asc().nullsLast().op("uuid_ops")),
	foreignKey({
	...
	index("zed_package_versions_sha256_idx").using("btree", table.sha256.asc().nullsLast().op("text_ops")),
...
export const zed_dependency_graph_edges = pgTable("zed_dependency_graph_edges", {
	...
	uniqueIndex("zed_dependency_graph_edges_artifact_ordinal_uq").using("btree", table.graph_artifact_id.asc().nullsLast().op("int4_ops"), table.ordinal.asc().nullsLast().op("uuid_ops")),
	...
	index("zed_dependency_graph_edges_from_package_idx").using("btree", table.from_package_id.asc().nullsLast().op("uuid_ops"), table.graph_artifact_id.asc().nullsLast().op("uuid_ops")).where(sql`(from_package_id IS NOT NULL)`),
	foreignKey({
			columns: [table.from_package_version_id],
			foreignColumns: [zed_package_versions.id],
			name: "zed_dependency_graph_edges_from_version_fk"
		}).onDelete("set null"),
	index("zed_dependency_graph_edges_from_version_idx").using("btree", table.from_package_version_id.asc().nullsLast().op("uuid_ops"), table.graph_artifact_id.asc().nullsLast().op("uuid_ops")).where(sql`(from_package_version_id IS NOT NULL)`),
	index("zed_dependency_graph_edges_incoming_idx").using("btree", table.to_registry_id.asc().nullsLast().op("text_ops"), table.to_org_slug.asc().nullsLast().op("text_ops"), table.to_package_name.asc().nullsLast().op("int4_ops"), table.minimum_depth.asc().nullsLast().op("text_ops")),
	index("zed_dependency_graph_edges_incoming_version_idx").using("btree", table.to_registry_id.asc().nullsLast().op("uuid_ops"), table.to_org_slug.asc().nullsLast().op("int4_ops"), table.to_package_name.asc().nullsLast().op("uuid_ops"), table.to_version.asc().nullsLast().op("text_ops"), table.minimum_depth.asc().nullsLast().op("int4_ops"), table.graph_artifact_id.asc().nullsLast().op("text_ops"), table.ordinal.asc().nullsLast().op("uuid_ops")).where(sql`(to_version IS NOT NULL)`),
	...
	index("zed_dependency_graph_edges_outgoing_idx").using("btree", table.from_registry_id.asc().nullsLast().op("text_ops"), table.from_org_slug.asc().nullsLast().op("text_ops"), table.from_package_name.asc().nullsLast().op("text_ops"), table.minimum_depth.asc().nullsLast().op("int4_ops")),
	index("zed_dependency_graph_edges_outgoing_version_idx").using("btree", table.from_registry_id.asc().nullsLast().op("int4_ops"), table.from_org_slug.asc().nullsLast().op("uuid_ops"), table.from_package_name.asc().nullsLast().op("int4_ops"), table.from_version.asc().nullsLast().op("text_ops"), table.minimum_depth.asc().nullsLast().op("uuid_ops"), table.graph_artifact_id.asc().nullsLast().op("uuid_ops"), table.ordinal.asc().nullsLast().op("text_ops")).where(sql`(from_version IS NOT NULL)`),
	...
	index("zed_dependency_graph_edges_to_package_idx").using("btree", table.to_package_id.asc().nullsLast().op("uuid_ops"), table.graph_artifact_id.asc().nullsLast().op("uuid_ops")).where(sql`(to_package_id IS NOT NULL)`),
	foreignKey({
			columns: [table.to_package_version_id],
			foreignColumns: [zed_package_versions.id],
			name: "zed_dependency_graph_edges_to_version_fk"
		}).onDelete("set null"),
	index("zed_dependency_graph_edges_to_version_idx").using("btree", table.to_package_version_id.asc().nullsLast().op("uuid_ops"), table.graph_artifact_id.asc().nullsLast().op("uuid_ops")).where(sql`(to_package_version_id IS NOT NULL)`),
	index("zed_dependency_graph_edges_unresolved_target_idx").using("btree", table.to_registry_id.asc().nullsLast().op("text_ops"), table.to_org_slug.asc().nullsLast().op("text_ops"), table.to_package_name.asc().nullsLast().op("text_ops")).where(sql`(to_package_version_id IS NULL)`),
...
export const zed_package_uploads = pgTable("zed_package_uploads", {
	...
	index("zed_package_uploads_package_idx").using("btree", table.package_id.asc().nullsLast().op("uuid_ops"), table.started_at.desc().nullsFirst().op("timestamptz_ops")),
	...
	index("zed_package_uploads_status_idx").using("btree", table.status.asc().nullsLast().op("timestamptz_ops"), table.started_at.desc().nullsFirst().op("text_ops")),
	...
	index("zed_package_uploads_user_idx").using("btree", table.uploaded_by_user_id.asc().nullsLast().op("timestamptz_ops"), table.started_at.desc().nullsFirst().op("uuid_ops")).where(sql`(uploaded_by_user_id IS NOT NULL)`),
	...
	index("zed_package_uploads_version_idx").using("btree", table.package_version_id.asc().nullsLast().op("uuid_ops")).where(sql`(package_version_id IS NOT NULL)`),
]);
...
export const zed_package_licenses = pgTable("zed_package_licenses", {
	...
	index("zed_package_licenses_package_idx").using("btree", table.package_id.asc().nullsLast().op("uuid_ops")),
	uniqueIndex("zed_package_licenses_package_primary_uq").using("btree", table.package_id.asc().nullsLast().op("uuid_ops")).where(sql`((package_version_id IS NULL) AND is_primary)`),
	...
	index("zed_package_licenses_spdx_idx").using("btree", table.spdx_id.asc().nullsLast().op("text_ops")).where(sql`(spdx_id IS NOT NULL)`),
	...
	index("zed_package_licenses_version_idx").using("btree", table.package_version_id.asc().nullsLast().op("uuid_ops")).where(sql`(package_version_id IS NOT NULL)`),
	uniqueIndex("zed_package_licenses_version_primary_uq").using("btree", table.package_version_id.asc().nullsLast().op("uuid_ops")).where(sql`((package_version_id IS NOT NULL) AND is_primary)`),
]);
...
export const zed_entity_embeddings = pgTable("zed_entity_embeddings", {
	...
	index("zed_entity_embeddings_entity_idx").using("btree", table.entity_type.asc().nullsLast().op("uuid_ops"), table.entity_id.asc().nullsLast().op("text_ops")),
	uniqueIndex("zed_entity_embeddings_entity_model_sha_uq").using("btree", table.entity_type.asc().nullsLast().op("uuid_ops"), table.entity_id.asc().nullsLast().op("text_ops"), table.embedding_model.asc().nullsLast().op("uuid_ops"), table.content_sha256.asc().nullsLast().op("uuid_ops")),
	...
	index("zed_entity_embeddings_org_model_idx").using("btree", table.org_id.asc().nullsLast().op("uuid_ops"), table.embedding_model.asc().nullsLast().op("uuid_ops")).where(sql`(org_id IS NOT NULL)`),
...
export const zed_audit_log = pgTable("zed_audit_log", {
	...
	index("zed_audit_log_actor_idx").using("btree", table.actor_user_id.asc().nullsLast().op("uuid_ops"), table.created_at.desc().nullsFirst().op("timestamptz_ops")).where(sql`(actor_user_id IS NOT NULL)`),
	check("zed_audit_log_detail_object_chk", sql`jsonb_typeof(detail) = 'object'::text`),
	index("zed_audit_log_entity_idx").using("btree", table.entity_type.asc().nullsLast().op("timestamptz_ops"), table.entity_id.asc().nullsLast().op("timestamptz_ops"), table.created_at.desc().nullsFirst().op("text_ops")),
	...
	index("zed_audit_log_org_idx").using("btree", table.org_id.asc().nullsLast().op("uuid_ops"), table.created_at.desc().nullsFirst().op("uuid_ops")).where(sql`(org_id IS NOT NULL)`),
	foreignKey({
			columns: [table.api_token_id],
			foreignColumns: [zed_api_tokens.id],
...
export const zed_api_tokens = pgTable("zed_api_tokens", {
	...
	index("zed_api_tokens_org_idx").using("btree", table.org_id.asc().nullsLast().op("uuid_ops")).where(sql`(org_id IS NOT NULL)`),
	...
	uniqueIndex("zed_api_tokens_token_hash_uq").using("btree", table.token_hash.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.user_id],
			foreignColumns: [zed_users.id],
			name: "zed_api_tokens_user_fk"
		}).onDelete("cascade"),
	index("zed_api_tokens_user_idx").using("btree", table.user_id.asc().nullsLast().op("uuid_ops")).where(sql`(user_id IS NOT NULL)`),
]);
...
export const zed_package_downloads = pgTable("zed_package_downloads", {
	...
	index("zed_package_downloads_created_at_idx").using("btree", table.created_at.desc().nullsFirst().op("timestamptz_ops")),
	...
	index("zed_package_downloads_package_idx").using("btree", table.package_id.asc().nullsLast().op("timestamptz_ops"), table.created_at.desc().nullsFirst().op("timestamptz_ops")),
	...
	index("zed_package_downloads_user_idx").using("btree", table.downloaded_by_user_id.asc().nullsLast().op("uuid_ops"), table.created_at.desc().nullsFirst().op("timestamptz_ops")).where(sql`(downloaded_by_user_id IS NOT NULL)`),
	foreignKey({
			columns: [table.package_version_id],
			foreignColumns: [zed_package_versions.id],
			name: "zed_package_downloads_version_fk"
		}).onDelete("set null"),
	index("zed_package_downloads_version_idx").using("btree", table.package_version_id.asc().nullsLast().op("timestamptz_ops"), table.created_at.desc().nullsFirst().op("uuid_ops")).where(sql`(package_version_id IS NOT NULL)`),
]);
...
export const zed_org_members = pgTable("zed_org_members", {
	...
	index("zed_org_members_user_idx").using("btree", table.user_id.asc().nullsLast().op("uuid_ops"), table.org_id.asc().nullsLast().op("uuid_ops")),
]);
...
export const zed_project_members = pgTable("zed_project_members", {
	...
	index("zed_project_members_user_idx").using("btree", table.user_id.asc().nullsLast().op("uuid_ops"), table.project_id.asc().nullsLast().op("uuid_ops")),
]);
